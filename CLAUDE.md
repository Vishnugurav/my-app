...
```mermaid
graph TD
  79893bea["ERC-721 NFT"]
  d672ee32["Frontend"]
  66a4446e["Wallet Auth"]
  79893bea --> d672ee32
  d672ee32 --> 66a4446e
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--79893bea.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--d672ee32.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--66a4446e.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--79893bea.md)
- [Frontend](.nskills/components/frontend-scaffold--d672ee32.md)
- [Wallet Auth](.nskills/components/wallet-auth--66a4446e.md)
